...
- Name: shop.spec.js >> Nazionalità: autocomplete dropdown funziona
- Location: tests\shop.spec.js:84:1
...
Locator: locator('text=Customer Registration')
Expected: visible
Timeout: 35000ms
...
Call log:
  ...
  - waiting for locator('text=Customer Registration')
    - waiting for navigation to finish...
    - navigated to "https://ciliegio-shop.netlify.app/ciliegioshop"
